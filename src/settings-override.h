// clang-format off
	...
	*/
	...
	//#define RFID_READER_TYPE_PN5180       // use PN5180 via SPI
		...
		constexpr uint8_t rfidGain = 0x04 << 4;      // Sensitivity of RC522. For possible values see reference: https://forum.espuino.de/uploads/default/original/1X/9de5f8d35cbc123c1378cad1beceb3f51035cec0.png
	#endif
	...
	*/
	...
	#define BUTTON_2_LONG     CMD_TOGGLE_WIFI_STATUS
	#define BUTTON_3_LONG     CMD_SLEEPMODE
	#define BUTTON_4_LONG     CMD_VOLUMEUP
	#define BUTTON_5_LONG     CMD_VOLUMEDOWN

	#define BUTTON_MULTI_01   CMD_TOGGLE_MODE   //CMD_TOGGLE_WIFI_STATUS (disabled now to prevent children from unwanted WiFi-disable)
